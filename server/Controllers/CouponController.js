...
export const createCoupon = {
    validator: async (req, res, next) => {
        ...
        if (!code || !title || !terms || !expirydate || !price || !company || !companylogo || !category) {
    ...
    controller: async (req, res) => {
        ...
        try {
            const newCoupon = await Coupon.create({
                code, title, terms, expirydate, price, company, companylogo, category, sellerid
            });
    ...
    controller: async (req, res) => {
        ...
        try {
            ...
            const updateCoupon = await Coupon.findByIdAndUpdate(
                req.body._id,
                {
                    code, title, terms, expirydate, price, company, category
                },
                { new: true }
            );
...
export const findAllCoupons = {
    controller: async (req, res) => {
        try {
            ...
            const currentPageCoupons = allCoupons.slice(
                currentCouponidx,
                currentCouponidx + limit
            );
